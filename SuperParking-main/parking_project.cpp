...
//dervied class from public and class is dervied publically
...
//USER INTERFACE
    do
    {
        ...
        if(t==3)
        {
            ...
            if(strcmp(pass_to_admin,"n007")==0)
            {
                ...
                else if(q==2)
                {
                    ...
                    //vechile not found or invalid vwchile no.
                }
            }
            else
            {
        ...
        else if(t==2)
        {
            ...
            int id_check;
            cin>>id_check;     // id se vechile type nikalo then us building me jake us floor ki hi id check kro
            for(int i=1;i<=10;i++)
            {
                for(int j=1;j<=10;j++)
                {
